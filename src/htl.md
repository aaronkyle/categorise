...
NOTE: This needs to be adapted to work with Mutable

ref: https://raw.githubusercontent.com/observablehq/framework/refs/heads/main/docs/lib/htl.md
-->
...
<!--
```js echo
// NOTE: This breaks in Framework.  Omitting.
