...
A [radar chart](https://en.wikipedia.org/wiki/Radar_chart) can show three or more quantitative variables on axes starting from the same point. They are also known as spider chart or star plot. They can be used to plot data among similar groups, people, or objects.
